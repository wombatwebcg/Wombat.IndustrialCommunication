...
namespace Wombat.Network.Build.Configuration
{
    ...
    /// UDP服务配置选项
    /// </summary>
    public class UdpSocketServiceOptions
    {
        /// <summary>
        /// 服务器配置
        /// </summary>
        public UdpServerOptions Server { get; set; } = new UdpServerOptions();

        /// <summary>
        /// 客户端配置
        /// </summary>
        public UdpClientOptions Client { get; set; } = new UdpClientOptions();
    }
    ...
    public class UdpClientOptions
    {
        ...
        /// 客户端配置
        /// </summary>
        public UdpSocketClientConfiguration Configuration { get; set; }
