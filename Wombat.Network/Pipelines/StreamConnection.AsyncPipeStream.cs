...
namespace Pipelines.Sockets.Unofficial
{
    public static partial class StreamConnection
    {
        ...
        public sealed partial class AsyncPipeStream : Stream
        {
            ...
            private AsyncReadResult PendingRead
            {
                get
                {
                    if (_pendingRead == null)
                    {
                        _pendingRead = new AsyncReadResult();
                    }
                    return _pendingRead;
                }
            }
            private AsyncWriteResult PendingWrite
            {
                get
                {
                    if (_pendingWrite == null)
                    {
                        _pendingWrite = new AsyncWriteResult();
                    }
                    return _pendingWrite;
                }
            }

            private FlushToken FlushInstance
            {
                get
                {
                    if (_flushInstance == null)
                    {
                        _flushInstance = new FlushToken();
                    }
                    return _flushInstance;
                }
            }


            private Action _processDataFromAwaiter;
            private Action ProcessDataFromAwaiter
            {
                get
                {
                    if (_processDataFromAwaiter == null)
                    {
                        _processDataFromAwaiter = ProcessDataFromAwaiterImpl;
                    }
                    return _processDataFromAwaiter;
                }
            }
